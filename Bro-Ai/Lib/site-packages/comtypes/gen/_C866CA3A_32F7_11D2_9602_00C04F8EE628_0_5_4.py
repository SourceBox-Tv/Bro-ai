...
__all__ = [
    'SDTPronunciation', 'ISpeechPhraseRule', 'SPINTERFERENCE_TOOLOUD',
    'SpNullPhoneConverter', 'DISPID_SBSRead', 'SVPAlert',
    'SP_VISEME_16', 'DISPID_SRSNumberOfActiveRules', 'SPFM_CREATE',
    'DISPID_SVEventInterests', 'SPAS_PAUSE', 'DISPID_SRRTTickCount',
    'SRSInactiveWithPurge', 'SpeechEngineConfidence',
    'tagSPPROPERTYINFO', 'eLEXTYPE_RESERVED7', 'SVSFIsNotXML',
    'SPPS_Function', 'ISpeechLexiconPronunciation', 'SPSInterjection',
    'DISPIDSPTSI', 'ISpeechCustomStream',
    'DISPID_SRSetPropertyString',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SP_VISEME_8',
    'ISpeechLexicon', 'SVSFNLPSpeakPunc', 'SLOStatic',
    'Speech_Max_Pron_Length', 'SPEI_START_INPUT_STREAM',
    'SPPHRASEPROPERTY', 'DISPID_SRGetRecognizers', 'SPPS_Noun',
    'SPBO_PAUSE', 'SAFTExtendedAudioFormat', 'DISPID_SPIReplacements',
    'SP_VISEME_6', 'SPEI_SOUND_END', 'DISPID_SRGCommit',
    'SVSFDefault', 'DISPID_SGRSTNextState', 'SECLowConfidence',
    'ISpeechGrammarRuleState', 'DISPID_SVSLastResult',
    'SpeechLoadOption', 'DISPID_SRCAudioInInterferenceStatus',
    'SPPS_Unknown', 'SPEI_PHONEME', 'DISPID_SASFreeBufferSpace',
    'SPEI_SR_BOOKMARK', 'SITooSlow', 'SPDKL_LocalMachine',
    'STCLocalServer', 'DISPID_SRCEBookmark',
    'DISPID_SGRSAddWordTransition', 'SVP_8', 'IEnumString',
    ...
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SPPConfidence',
    'DISPID_SOTsCount', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SPIGetText', 'DISPID_SOTMatchesAttributes',
    'DISPID_SVResume', 'SECFEmulateResult', 'SP_VISEME_9',
    'DISPID_SCSBaseStream', 'ISpeechRecoResult', 'SPSNotOverriden',
    'Speech_StreamPos_Asap', 'DISPID_SRCRecognizer',
    'SPEI_TTS_AUDIO_LEVEL', 'SpeechTokenIdUserLexicon',
    'DISPID_SPRuleConfidence', 'SRESoundStart',
    'ISpeechObjectTokenCategory', 'DISPID_SRRGetXMLResult',
    'SVSFParseSsml', 'SPPS_Modifier', 'DISPIDSPRG',
    'DISPID_SWFEFormatTag', 'DISPID_SpeechObjectTokens',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SPRuleFirstElement',
    'SREFalseRecognition', 'DISPID_SRCCreateResultFromMemory',
    'eLEXTYPE_RESERVED6', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SFSClose', 'SPPS_RESERVED3', 'SVP_15', 'SVPNormal',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SPPsItem', 'WAVEFORMATEX',
    'DISPID_SPEEngineConfidence', 'SPPS_SuppressWord',
    'SPCT_DICTATION', 'DISPID_SRRSaveToMemory', 'DISPID_SVEViseme',
    'SpeechCategoryPhoneConverters', 'ISpeechPhraseInfo',
    'DISPID_SpeechRecoResult2', 'eLEXTYPE_PRIVATE6', 'SVP_13',
    'DISPID_SGRAddResource', 'SSSPTRelativeToCurrentPosition',
    ...
    'DISPID_SPPEngineConfidence', 'SPGS_ENABLED', 'DISPID_SRGId',
    'SpeechFormatType', 'DISPID_SABufferNotifySize',
    'SAFT24kHz16BitStereo', 'SAFT22kHz16BitStereo',
    'SpeechVoiceCategoryTTSRate', 'SAFT32kHz8BitStereo',
    'DISPID_SRCEPropertyNumberChange', 'SECHighConfidence',
    'DISPID_SGRSTPropertyValue', 'SpeechSpecialTransitionType',
    'DISPID_SAFSetWaveFormatEx', 'SRAExport', 'ISpeechLexiconWord',
    'SAFTCCITT_ALaw_8kHzStereo', 'SPVPRIORITY', 'SPVISEMES',
    'DISPID_SVIsUISupported', 'DISPID_SRCVoicePurgeEvent',
    'ISpeechTextSelectionInformation', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'ISpeechPhraseInfoBuilder', 'DISPID_SOTGetAttribute',
    'DISPID_SOTCategory', 'DISPID_SWFESamplesPerSec',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SRCResume',
    'DISPID_SOTCDefault', 'ISpeechVoice',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SWFEChannels',
    'eLEXTYPE_USER', 'SPEVENTENUM', 'ISpRecognizer',
    'DISPID_SpeechFileStream', 'DISPID_SRSCurrentStreamNumber',
    'SPSUnknown', 'DISPID_SVWaitUntilDone', 'ISpRecoContext2',
    'DISPID_SPRsItem', 'SPEI_TTS_BOOKMARK', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SLGetGenerationChange', 'DISPID_SLWLangId',
    'SVSFParseMask', 'SASPause', 'SPPS_Interjection', 'SPAS_CLOSED',
    'SDTAll', 'DISPID_SVAlertBoundary', 'DISPID_SVEWord',
    'SpeechTokenKeyUI', 'DISPID_SPANumberOfElementsInResult',
    'DISPID_SBSFormat', 'DISPID_SPIEngineId', 'SpeechVoiceEvents',
    'SAFTCCITT_uLaw_11kHzStereo', 'SPEI_WORD_BOUNDARY',
    'SGDSActiveWithAutoPause', 'DISPID_SPIRetainedSizeBytes',
    'ISpPhraseAlt', 'SVP_6', 'SAFT8kHz16BitStereo',
    'SpeechEmulationCompareFlags', 'DISPID_SpeechLexiconWord',
    'DISPID_SVStatus', 'SpSharedRecoContext',
    'DISPID_SRCEFalseRecognition', 'DISPID_SGRName',
    'eLEXTYPE_PRIVATE7', 'SAFT22kHz8BitMono',
    'DISPID_SVSLastBookmarkId', 'SPWORDLIST', 'SRAImport',
    'DISPID_SRCERecognizerStateChange', 'SpeechRuleState',
    'SPRS_ACTIVE', 'SPDATAKEYLOCATION', 'DISPID_SRGIsPronounceable',
    'SPSERIALIZEDPHRASE', 'SAFTADPCM_8kHzMono',
    'DISPID_SRRGetXMLErrorInfo', 'SGRSTTWord', 'DISPID_SRCVoice',
    'SAFT48kHz16BitStereo', 'eLEXTYPE_PRIVATE15', 'SDKLLocalMachine',
    'eLEXTYPE_PRIVATE8', 'SPAO_NONE', 'DISPID_SPRuleEngineConfidence',
    'SGDSActive', 'STCInprocServer', 'ISpStreamFormat',
    'ISpeechPhraseRules', 'eLEXTYPE_RESERVED9', 'SINone',
    'SpMemoryStream', 'tagSTATSTG', 'DISPID_SRCEPropertyStringChange',
    'SPXMLRESULTOPTIONS', 'SAFT32kHz8BitMono',
    'DISPID_SRGDictationLoad', 'SPEI_SOUND_START',
    'ISpeechMemoryStream', 'SP_VISEME_13', 'SpMMAudioOut',
    ...
    'SAFT24kHz16BitMono', 'DISPID_SGRSAddRuleTransition',
    'DISPID_SRCEventInterests', 'ISpRecoCategory',
    'ISpeechObjectTokens', 'SPINTERFERENCE_NOISE',
    'DISPID_SRRSpeakAudio', 'DISPID_SRGSetTextSelection',
    'DISPID_SRCEInterference', 'SRERequestUI', 'SRERecoOtherContext',
    'DISPID_SMSGetData', 'DISPID_SPRuleName', 'SPWORDPRONUNCIATION',
    'SVP_20', 'SAFTCCITT_uLaw_22kHzMono', 'SGSEnabled',
    'DISPID_SPPName', 'SWPUnknownWordPronounceable',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SpeechPhraseProperty',
    'SRSActiveAlways', 'DISPID_SVAudioOutput', 'SITooQuiet',
    'DISPID_SRSAudioStatus', 'DISPID_SLPsCount', 'SAFT11kHz8BitMono',
    'SAFT24kHz8BitStereo', 'ISpNotifySink', 'SPPROPERTYINFO',
    'SPEI_VISEME', 'DISPID_SpeechMMSysAudio', 'DISPID_SRRAudioFormat',
    'DISPID_SRDisplayUI', 'DISPID_SPEDisplayText', 'SVP_16',
    'DISPID_SPAsItem', 'tagSPTEXTSELECTIONINFO', 'SP_VISEME_10',
    'SAFTADPCM_44kHzMono', 'SpeechGrammarWordType',
    'DISPID_SRRPhraseInfo', 'IStream', 'Speech_StreamPos_RealTime',
    'SPVPRI_ALERT', 'SP_VISEME_17', 'DISPID_SGRSTsItem',
    'DISPID_SpeechPhraseReplacements', 'ISpResourceManager',
    'DISPID_SLGetWords', 'DISPID_SPRs_NewEnum', 'SVF_Stressed',
    'DISPID_SpeechPhraseBuilder', 'SpSharedRecognizer',
    'SPFM_OPEN_READONLY', 'DISPID_SPIRule', 'SWTDeleted',
    'DISPID_SVSInputWordLength', 'SPWT_DISPLAY', 'SVP_5',
    'DISPID_SPEPronunciation', 'SPBO_AHEAD', 'ISpMMSysAudio',
    'SpCompressedLexicon', 'eLEXTYPE_PRIVATE12', 'SPEI_MAX_SR',
    'DISPID_SAVolume', 'DISPID_SRRecognizer', 'SVSFParseSapi',
    'SpeechPropertyHighConfidenceThreshold', 'ISpRecoGrammar2',
    'SRSEIsSpeaking', 'DISPID_SGRSRule', 'SGRSTTRule', 'SITooLoud',
    'SPAR_Low', 'DISPID_SASNonBlockingIO',
    'DISPID_SPPBRestorePhraseFromMemory', 'ISpSerializeState',
    'SPAS_RUN', 'SAFT44kHz8BitStereo', 'SPPS_RESERVED4',
    'DISPID_SGRInitialState', 'SAFTADPCM_22kHzMono',
    'DISPID_SOTGetStorageFileName', 'eLEXTYPE_PRIVATE4',
    'SpeechRuleAttributes', 'DISPID_SPEsCount', 'SAFT48kHz16BitMono',
    'ISpRecognizer3', 'SPINTERFERENCE_NONE', 'DISPID_SLGenerationId',
    'DISPID_SPRText', 'ISpeechGrammarRules', 'DISPID_SVPause',
    'SAFT22kHz8BitStereo', 'ISpeechAudioStatus', 'SPSModifier',
    'SWPUnknownWordUnpronounceable', 'DISPID_SpeechAudioFormat',
    'DISPID_SWFEBlockAlign', 'SPSHT_OTHER', 'SAFT11kHz16BitMono',
    'DISPID_SPRulesItem', 'DISPID_SRCEHypothesis', 'SPEI_REQUEST_UI',
    'SAFT8kHz8BitStereo', 'ISpeechPhraseReplacement', 'SRCS_Disabled',
    'SPFM_OPEN_READWRITE', 'DISPID_SRGCmdLoadFromResource',
    'DISPID_SVSInputWordPosition', 'ISpRecoContext',
    'DISPID_SVEPhoneme', 'DISPID_SGRsDynamic', 'DISPID_SGRsCount',
    'SVP_21', 'SAFT12kHz8BitMono', 'STSF_AppData', 'SPEI_TTS_PRIVATE',
    'eLEXTYPE_APP', 'SPSNoun', 'DISPID_SLPPartOfSpeech',
    'SDTProperty', 'SAFTGSM610_8kHzMono', 'DISPID_SLPType',
    'SWPKnownWordPronounceable', 'ISpeechRecoGrammar',
    'SPEI_UNDEFINED', 'DISPID_SPIElements', 'SPSEMANTICERRORINFO',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SAFT12kHz16BitMono',
    'SpeechInterference', 'DISPID_SPRuleParent', 'SVP_2',
    'SRTExtendableParse', 'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPWORD',
    'SPSEMANTICFORMAT', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SRCEEndStream', 'SPSFunction', 'SPEI_PHRASE_START',
    'SGLexicalNoSpecialChars', 'SLTUser',
    'DISPID_SRGetPropertyNumber', 'SSSPTRelativeToEnd', 'SINoise',
    'SpeechTokenContext', 'SpeechVisemeFeature', 'ISpeechGrammarRule',
    'SP_VISEME_2', 'DISPID_SMSSetData', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SRGSetWordSequenceData', 'SDA_One_Trailing_Space',
    'SDKLCurrentUser', 'SASStop', 'DISPID_SWFEBitsPerSample',
    'DISPID_SDKSetLongValue', 'DISPID_SVSPhonemeId',
    'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SpPhoneticAlphabetConverter', 'DISPID_SVDisplayUI', 'ISpAudio',
    'SPPS_NotOverriden', 'SPPHRASEELEMENT', 'SP_VISEME_4',
    'SRADefaultToActive', 'SPPHRASERULE', 'SAFT11kHz16BitStereo',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SRCEAdaptation',
    'SpObjectTokenCategory', 'ISpPhoneticAlphabetConverter', 'SVP_9',
    'SpeechCategoryAppLexicons', 'DISPID_SpeechObjectToken',
    'SpeechTokenShellFolder', 'DISPID_SPCLangId', 'DISPID_SMSALineId',
    'SPPARTOFSPEECH', 'DISPID_SVSInputSentenceLength',
    'DISPID_SVEEnginePrivate', 'DISPID_SVSLastBookmark',
    'SDTReplacement', 'DISPID_SRSClsidEngine', 'SGDSInactive',
    'SpeechCategoryAudioIn', 'SAFT12kHz8BitStereo',
    'DISPID_SpeechAudio', 'SAFT32kHz16BitStereo', 'DISPID_SGRsAdd',
    'SAFTText', 'DISPID_SPIAudioSizeTime',
    'SpeechCategoryRecognizers', 'SpeechGrammarState',
    'SAFTADPCM_44kHzStereo', 'SVESentenceBoundary',
    'DISPID_SVGetAudioInputs', 'SPEI_RESERVED3',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SpeechPhoneConverter',
    'ISpeechRecognizerStatus', 'SAFTCCITT_uLaw_11kHzMono', 'SPEVENT',
    'eWORDTYPE_DELETED', 'SPEI_RESERVED5', 'SpeechAudioState',
    'STCRemoteServer', 'SpeechPropertyAdaptationOn',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SGRSTsCount',
    'SVSFPersistXML', 'DISPID_SRRAudio', 'SpCustomStream',
    'SpeechAudioFormatGUIDWave', 'SPVPRI_OVER',
    'DISPID_SPISaveToMemory',
    'DISPID_SpeechGrammarRuleStateTransition', 'DISPID_SDKCreateKey',
    'DISPID_SRCEPhraseStart', 'ISpObjectWithToken', 'SVSFUnusedFlags',
    'DISPID_SpeechGrammarRuleStateTransitions', 'ISpeechAudio',
    'DISPID_SPIAudioSizeBytes', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SPPValue', 'DISPID_SPAs_NewEnum', 'SPVOICESTATUS',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SVP_17',
    'SAFTGSM610_11kHzMono', 'SVSFIsFilename',
    'DISPIDSPTSI_ActiveOffset', 'eLEXTYPE_VENDORLEXICON', 'SWTAdded',
    'SPEI_MIN_TTS', 'DISPID_SGRSTPropertyName', 'SpObjectToken',
    'SP_VISEME_21', 'SBONone', 'DISPID_SpeechMemoryStream',
    'SSFMOpenForRead', 'SDA_Two_Trailing_Spaces',
    'DISPID_SpeechVoiceStatus', 'ISpeechRecognizer', 'SDTLexicalForm',
    'DISPID_SABIEventBias', 'SPRECORESULTTIMES', 'SpeechUserTraining',
    'DISPID_SAFType', 'DISPID_SGRs_NewEnum', 'DISPID_SRRTimes',
    'SpeechLexiconType', 'SPSHORTCUTPAIR', 'STCInprocHandler',
    'SPINTERFERENCE_NOSIGNAL', 'SPPS_RESERVED2',
    'DISPID_SVSInputSentencePosition',
    'DISPID_SPIAudioStreamPosition', 'SP_VISEME_12',
    'DISPID_SLPsItem', 'ISpeechObjectToken', 'SPBO_TIME_UNITS',
    'DISPID_SRIsShared', 'DISPID_SASState', 'ISpeechPhraseProperty',
    'DISPID_SLGetPronunciations', 'SpeechPartOfSpeech',
    'DISPID_SVSyncronousSpeakTimeout', 'SPRULE', 'ISpeechAudioFormat',
    'ISpXMLRecoResult', 'SFTSREngine', 'SpeechRecoProfileProperties',
    'eLEXTYPE_PRIVATE10', 'SPCS_DISABLED', 'DISPID_SLPs_NewEnum',
    'DISPID_SPEAudioStreamOffset', 'SpeechGrammarTagWildcard',
    'DISPID_SASCurrentDevicePosition', 'SPPS_Noncontent',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SpeechPhraseRules',
    'SGRSTTWildcard', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SRGRecoContext', 'SPLO_DYNAMIC', 'DISPID_SDKEnumKeys',
    'SRATopLevel', 'DISPID_SRGCmdLoadFromMemory',
    'ISpeechGrammarRuleStateTransition',
    'SpeechPropertyComplexResponseSpeed',
    'DISPID_SRCRetainedAudioFormat', 'SPEI_RECOGNITION',
    'SpInProcRecoContext', 'SVEPhoneme', 'SAFTCCITT_ALaw_22kHzStereo',
    'ISpeechPhoneConverter', 'SRADynamic', 'DISPID_SLWs_NewEnum',
    'ISpeechRecoResultDispatch', 'SVSFNLPMask', 'SPAR_High',
    'SPPS_RESERVED1', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SpeechPhraseElements', 'SpeechStreamSeekPositionType',
    'eLEXTYPE_PRIVATE18', 'DISPID_SRGRules', 'SPINTERFERENCE_TOOFAST',
    'SPEI_RECO_STATE_CHANGE', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SGRSAddSpecialTransition', 'DISPIDSPTSI_SelectionLength',
    'ISpObjectToken', 'SpeechCategoryAudioOut',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SAFT16kHz8BitStereo',
    'SAFTADPCM_22kHzStereo', 'ISpRecognizer2',
    'SpTextSelectionInformation', 'DISPID_SPERetainedSizeBytes',
    'SpeechRecognizerState', 'SGRSTTEpsilon', 'SPCS_ENABLED',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SPELexicalForm',
    'ISpeechPhraseReplacements', 'SPINTERFERENCE', 'SpeechRecoEvents',
    'SREPrivate', 'SVF_None', 'DISPID_SMSADeviceId', 'SPPHRASE',
    'SAFT16kHz16BitStereo', 'SPEI_END_INPUT_STREAM',
    'SAFT22kHz16BitMono', 'SAFT11kHz8BitStereo',
    'DISPID_SPCIdToPhone', 'DISPID_SPRFirstElement',
    'DISPID_SRGState', 'SGSExclusive', 'ISpStream', 'SLODynamic',
    'SPWORDTYPE', 'eLEXTYPE_PRIVATE11', 'SpeechRunState',
    'SpeechDictationTopicSpelling', 'DISPID_SPRDisplayAttributes',
    ...
    'SPSSuppressWord', 'SECNormalConfidence', 'DISPID_SOTCGetDataKey',
    'SP_VISEME_11', 'eLEXTYPE_USER_SHORTCUT', 'SpStream',
    'DISPID_SAEventHandle', 'SVP_10',
    'DISPID_SPAStartElementInResult', 'ISpeechPhraseProperties',
    'SVEAllEvents', 'DISPID_SPAPhraseInfo',
    'SpeechRetainedAudioOptions', 'SP_VISEME_15', 'DISPID_SVVoice',
    'SGSDisabled', 'SPRS_ACTIVE_USER_DELIMITED', 'SPVPRI_NORMAL',
    'DISPID_SpeechXMLRecoResult', 'SpeechWordType',
    'SAFT16kHz8BitMono', 'DISPID_SGRAttributes',
    'DISPID_SVEStreamStart', 'SAFT48kHz8BitStereo',
    'SpeechWordPronounceable', 'SFTInput', 'SPSMF_UPS',
    'SpeechTokenKeyAttributes', 'DISPID_SAStatus', 'SRTAutopause',
    'DISPID_SGRsFindRule', 'DISPID_SGRSTType', 'SPCATEGORYTYPE',
    'DISPIDSPTSI_SelectionOffset', 'SP_VISEME_1', 'SSTTTextBuffer',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SpeechLexiconPronunciation',
    'SPPHRASEREPLACEMENT', 'ISpeechFileStream', 'ISpNotifyTranslator',
    'SDTAudio', 'SECFIgnoreWidth', 'SPCT_SUB_COMMAND',
    'DISPID_SVAudioOutputStream', 'DISPID_SGRSTransitions',
    'STSF_CommonAppData', 'SpeechVisemeType', 'SVEViseme',
    'SPLO_STATIC', 'SVP_0', 'SAFTCCITT_ALaw_11kHzStereo',
    'SAFTCCITT_uLaw_8kHzStereo', 'SRTReSent', 'SpResourceManager',
    'SPWF_INPUT', '__MIDL_IWinTypes_0009', 'DISPID_SGRsItem', 'SVP_1',
    'DISPID_SPARecoResult', 'ISpeechVoiceStatus', 'ISpRecoGrammar',
    'DISPID_SVSpeakStream', 'DISPID_SOTId', 'DISPID_SLWsItem',
    'SP_VISEME_19', 'DISPID_SOTCId', 'SREAdaptation',
    'DISPID_SPEDisplayAttributes', 'ISpeechRecoContext', 'SSFMCreate',
    'SRCS_Enabled', 'DISPID_SOTs_NewEnum', 'SPINTERFERENCE_TOOSLOW',
    'eLEXTYPE_PRIVATE14', 'SPPS_Verb', 'DISPID_SRProfile',
    'SP_VISEME_0', 'DISPID_SpeechPhraseInfo', 'SpeechBookmarkOptions',
    'DISPID_SLPPhoneIds', 'SPEI_START_SR_STREAM', 'eLEXTYPE_PRIVATE5',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SPRuleChildren',
    'DISPID_SGRId', 'SVP_3', 'eLEXTYPE_PRIVATE9', 'SPEVENTSOURCEINFO',
    'SpeechRegistryLocalMachineRoot', 'SVP_19',
    'SAFTADPCM_8kHzStereo', 'SREHypothesis', 'SVPOver',
    'DISPID_SRCreateRecoContext', 'SPSLMA', 'SPCT_SLEEP',
    'SPCT_SUB_DICTATION', 'eLEXTYPE_PRIVATE19', 'SAFT44kHz16BitMono',
    'SRTEmulated', 'ISpPhoneConverter', 'DISPID_SRCESoundStart',
    'DISPID_SPRuleNumberOfElements', 'SPWT_PRONUNCIATION',
    'DISPID_SAFGetWaveFormatEx', 'ISpeechLexiconPronunciations',
    'DISPID_SRCRequestedUIType', 'DISPID_SADefaultFormat',
    'SPXRO_Alternates_SML', 'DISPID_SRCEAudioLevel',
    'DISPID_SPERequiredConfidence', 'DISPID_SpeechGrammarRules',
    'ISpeechDataKey', 'SREPhraseStart', 'SVP_7', 'SRSActive',
    'DISPID_SPRuleId', 'DISPID_SLWWord', 'ISpObjectTokenCategory',
    'SPGRAMMARSTATE', 'SAFTNonStandardFormat', 'SPRECOCONTEXTSTATUS',
    'DISPID_SRGDictationUnload', 'SVSFlagsAsync',
    'DISPID_SVEVoiceChange', 'DISPID_SRCEStartStream',
    'Speech_Default_Weight', 'DISPID_SLWsCount',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SRCERecognitionForOtherContext', 'DISPID_SMSAMMHandle',
    'DISPID_SPPsCount', 'DISPID_SOTSetId', 'DISPID_SRCState',
    'SDTDisplayText', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SLPSymbolic', 'DISPID_SpeechDataKey', 'ISequentialStream',
    'ISpeechRecoResult2', 'SP_VISEME_14', 'SPTEXTSELECTIONINFO',
    'SVSFPurgeBeforeSpeak', 'DISPID_SWFEAvgBytesPerSec', 'SRARoot',
    'DISPID_SpeechRecoResult', 'SPSHORTCUTTYPE',
    'SPWORDPRONUNCIATIONLIST', 'SREPropertyNumChange',
    'SpeechRecoContextState', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SREBookmark', 'SpFileStream', 'DISPID_SGRSTPropertyId',
    'SRAInterpreter', 'DISPID_SRCSetAdaptationData', 'ISpRecoResult',
    'SpeechAudioProperties', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SpeechStreamFileMode', 'SPRST_ACTIVE', 'SpeechAddRemoveWord',
    'DISPID_SPEActualConfidence', 'SAFTCCITT_uLaw_22kHzStereo',
    'UINT_PTR', 'DISPID_SpeechRecognizer', 'DISPID_SPRsCount',
    'DISPID_SPRules_NewEnum', 'SPEI_HYPOTHESIS', 'DISPID_SGRSTWeight',
    'IInternetSecurityManager', 'SREAudioLevel', 'SGRSTTTextBuffer',
    'SAFTCCITT_ALaw_8kHzMono', 'SVEAudioLevel',
    'SPEI_SENTENCE_BOUNDARY', 'eWORDTYPE_ADDED', 'SPEI_ADAPTATION',
    'SVEPrivate', 'SPWF_SRENGINE', 'SpeechCategoryVoices',
    'SpUnCompressedLexicon', 'DISPID_SPIEnginePrivateData',
    'eLEXTYPE_RESERVED4', 'DISPID_SRSCurrentStreamPosition',
    'DISPID_SRCPause', 'SPWORDPRONOUNCEABLE', 'SPLOADOPTIONS',
    'SPWAVEFORMATTYPE', 'DISPID_SRGetPropertyString',
    'SVEWordBoundary', 'SPRS_INACTIVE',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SPAS_STOP',
    'DISPID_SVEAudioLevel', 'ISpeechPhraseElement', 'SPAR_Medium',
    'ISpVoice', 'SECFIgnoreKanaType', 'SpPhraseInfoBuilder',
    'DISPID_SRRTStreamTime', 'SAFTGSM610_22kHzMono',
    'DISPID_SPPChildren', 'STCAll', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SOTGetDescription', 'DISPID_SpeechGrammarRule',
    'DISPID_SPEs_NewEnum', 'DISPID_SPACommit', 'SDTRule',
    'DISPID_SGRsCommit', 'SP_VISEME_18', 'DISPID_SDKSetBinaryValue',
    'SPAUDIOSTATUS', 'SVEBookmark', 'SVP_18', 'DISPID_SPILanguageId',
    'DISPID_SRCRetainedAudio', 'SPWT_LEXICAL', 'SPAR_Unknown',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SVGetVoices',
    'DISPID_SOTDataKey', 'DISPID_SRCBookmark', 'DISPID_SOTsItem',
    'DISPID_SPPNumberOfElements', 'DISPID_SVEBookmark',
    'DISPID_SRAudioInput', 'SPPS_LMA', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SVGetProfiles', 'SpWaveFormatEx', 'DISPID_SGRAddState',
    'SPRECOSTATE', 'DISPID_SRStatus', 'SAFTDefault', 'ISpProperties',
    'DISPID_SABufferInfo', 'SPEI_MIN_SR', 'SGPronounciation',
    'DISPID_SBSSeek', 'DISPID_SGRSTRule', 'DISPID_SDKOpenKey',
    'DISPID_SGRsCommitAndSave', 'ISpStreamFormatConverter',
    'DISPID_SPEAudioSizeTime', 'DISPID_SDKGetlongValue',
    '_SPAUDIOSTATE', 'ISpLexicon', 'DISPID_SRCCmdMaxAlternates',
    'SDA_Consume_Leading_Spaces', 'SPEI_VOICE_CHANGE',
    'DISPID_SVSpeak', 'DISPID_SLWPronunciations',
    'DISPID_SpeechVoiceEvent', 'DISPID_SVSLastStreamNumberQueued',
    'SAFTADPCM_11kHzMono', 'SITooFast', 'SpeechEngineProperties',
    'SGDSActiveUserDelimited', 'IInternetSecurityMgrSite',
    'DISPID_SpeechCustomStream', 'SREInterference',
    'ISpeechPhraseAlternate', 'SSTTWildcard',
    'DISPID_SpeechAudioStatus', 'DISPID_SRGReset',
    'SAFT24kHz8BitMono', 'SpMMAudioEnum',
    'SpeechPropertyResponseSpeed', 'SVEVoiceChange', 'SVP_12',
    'SREAllEvents', 'SP_VISEME_5', 'SPAO_RETAIN_AUDIO',
    'DISPID_SpeechPhraseElement', 'DISPID_SOTDisplayUI',
    'DISPID_SpeechPhraseProperties', 'DISPID_SLPLangId',
    'SAFT32kHz16BitMono', 'ISpNotifySource',
    'ISpeechPhraseAlternates', 'SDTAlternates',
    'ISpeechRecoResultTimes', 'DISPID_SPPId', 'SpeechVoicePriority',
    'SREStreamEnd', 'DISPID_SWFEExtraData', 'SPAUDIOOPTIONS',
    'DISPID_SGRSTText', 'SPSVerb', 'DISPID_SRRRecoContext',
    'DISPID_SRSSupportedLanguages', 'SASRun', 'SpeechRecognitionType',
    'DISPID_SDKGetStringValue', 'SGDisplay', 'SpInprocRecognizer',
    'SRTSMLTimeout', 'SPSTREAMFORMATTYPE', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SABIBufferSize', 'SPRST_INACTIVE_WITH_PURGE',
    'ISpShortcut', 'SpeechGrammarTagUnlimitedDictation',
    'eLEXTYPE_PRIVATE3', 'SPRST_NUM_STATES',
    'SAFTCCITT_ALaw_22kHzMono', 'SRSEDone', 'SPDKL_CurrentConfig',
    'SpAudioFormat', 'SpeechVoiceSpeakFlags', '_ISpeechVoiceEvents',
    'DISPID_SpeechPhraseRule', 'SpMMAudioIn', 'SP_VISEME_20',
    'SVSFIsXML', 'DISPID_SRRSetTextFeedback',
    'ISpPhoneticAlphabetSelection', 'ISpeechLexiconWords',
    '_RemotableHandle', 'SPEI_INTERFERENCE', 'SPEI_SR_RETAINEDAUDIO',
    'SAFT8kHz16BitMono', 'SDA_No_Trailing_Space', 'DISPID_SRRTLength',
    'DISPID_SRAudioInputStream', 'eLEXTYPE_RESERVED8',
    'SPSHT_Unknown', 'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SpShortcut', 'DISPID_SVPriority', 'SpeechAllElements',
    'SpeechCategoryRecoProfiles', 'SVP_14', 'SAFT16kHz16BitMono',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'eLEXTYPE_PRIVATE2', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SOTCSetId', 'SPDKL_DefaultLocation',
    'DISPID_SPRNumberOfElements', 'SPRULESTATE',
    'DISPID_SRIsUISupported', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SpeechLexiconWords', 'Speech_Max_Word_Length',
    'SpeechAudioFormatType', 'DISPID_SRGDictationSetState',
    'SpeechDiscardType', 'SRTStandard', 'SPXRO_SML', 'SPEI_RESERVED2',
    ...
    'DISPID_SRGetFormat', 'SRAONone', 'SPGS_DISABLED',
    'SPSHORTCUTPAIRLIST', 'SPDKL_CurrentUser', 'ISpEventSink',
    'DISPID_SRSetPropertyNumber', 'SSFMOpenReadWrite', 'SVF_Emphasis',
    'ISpeechResourceLoader', 'SpeechMicTraining', 'SDKLCurrentConfig',
    'SP_VISEME_3', 'SPSERIALIZEDRESULT', 'SAFTADPCM_11kHzStereo',
    'DISPID_SRCCreateGrammar', 'DISPID_SLWType', 'SPFILEMODE',
    'STSF_LocalAppData', 'SINoSignal', 'DISPID_SRRDiscardResultInfo',
    'eLEXTYPE_PRIVATE1', 'ISpGrammarBuilder', 'ISpPhrase',
    'SPBO_NONE', 'DISPID_SVEStreamEnd', 'LONG_PTR',
    'eLEXTYPE_PRIVATE16', 'DISPID_SDKEnumValues', 'SRERecognition',
    'SLTApp', 'DISPID_SRRAlternates', 'SPGRAMMARWORDTYPE',
    'SPADAPTATIONRELEVANCE', 'SpeechDisplayAttributes',
    'SRAORetainAudio', 'DISPID_SRState', 'DISPID_SpeechRecoContext',
    'STSF_FlagCreate', 'SVP_11', 'DISPID_SABIMinNotification',
    'DISPID_SOTRemove', 'DISPID_SpeechVoice', 'SPSHT_NotOverriden',
    'DISPID_SpeechLexicon', 'SBOPause', 'eLEXTYPE_PRIVATE13',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SPEAudioTimeOffset',
    'SREStateChange', 'DISPID_SVSRunningState', 'SpNotifyTranslator',
    'DISPID_SOTCreateInstance', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SDKDeleteKey', 'DISPID_SVSkip', 'SVSFVoiceMask',
    'DISPID_SRCERequestUI', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SPIGrammarId', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SPEsItem', 'SAFT48kHz8BitMono',
    'DISPID_SDKGetBinaryValue', 'ISpeechWaveFormatEx',
    'DISPID_SAFGuid', 'DISPID_SVRate', 'SVP_4', 'SVEStartInputStream',
    'SpeechPropertyResourceUsage', 'DISPID_SGRClear',
    'DISPID_SpeechPhraseAlternates', 'SPAUDIOSTATE', 'SPEI_MAX_TTS',
    'SPRST_INACTIVE', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'ISpDataKey', 'SAFT8kHz8BitMono',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SVVolume',
    'SP_VISEME_7', 'SECFIgnoreCase', 'SVSFParseAutodetect',
    'SPEI_RECO_OTHER_CONTEXT', 'SpeechDataKeyLocation',
    'DISPID_SPPParent', 'DISPID_SDKSetStringValue',
    'SpeechAudioVolume', 'DISPID_SPPs_NewEnum', 'SPFM_NUM_MODES',
    'ISpeechMMSysAudio', 'SPFM_CREATE_ALWAYS', 'DISPID_SFSOpen',
    'SRESoundEnd', 'SGLexical', 'SpeechTokenKeyFiles',
    'DISPID_SRGCmdSetRuleIdState', 'ISpeechBaseStream',
    'eLEXTYPE_PRIVATE20', 'SREStreamStart', 'SPCONTEXTSTATE',
    'DISPID_SpeechLexiconProns', 'SpVoice', 'SASClosed',
    'SPEI_SR_PRIVATE', 'SAFT44kHz16BitStereo', 'SPGS_EXCLUSIVE',
    'SPBOOKMARKOPTIONS', 'SPEI_SR_AUDIO_LEVEL', 'SPEI_RESERVED6',
    'SPINTERFERENCE_LATENCY_WARNING', 'SDKLDefaultLocation',
    'DISPID_SASetState', 'SAFTNoAssignedFormat',
    'DISPID_SLAddPronunciation', 'SPCT_COMMAND', 'SECFDefault',
    'SSSPTRelativeToStart', 'SpStreamFormatConverter',
    'DISPID_SBSWrite', '_ISpeechRecoContextEvents',
    'SPEI_END_SR_STREAM', 'DISPID_SRCESoundEnd',
    'DISPID_SPEAudioSizeBytes', 'eLEXTYPE_RESERVED10',
    'DISPID_SpeechBaseStream', 'DISPID_SDKDeleteValue',
    'SVEEndInputStream', 'DISPID_SLRemovePronunciation',
    'IEnumSpObjectTokens', 'SpeechAudioFormatGUIDText',
    'DISPID_SPIStartTime', 'DISPID_SPIProperties', 'SpLexicon',
    'SAFT12kHz16BitStereo', 'DISPID_SPCPhoneToId',
    'DISPID_SRCERecognition', 'ISpeechPhraseElements',
    'SECFNoSpecialChars', 'SGRSTTDictation', 'SpeechTokenValueCLSID',
    'SSTTDictation', 'ISpeechAudioBufferInfo', 'SAFT44kHz8BitMono',
    'DISPID_SOTIsUISupported', 'SpPhoneConverter', 'SPLEXICONTYPE',
    'SPAUDIOBUFFERINFO', 'SPEI_RESERVED1', 'SPSHT_EMAIL',
    'SPBINARYGRAMMAR', 'DISPID_SpeechPhraseReplacement',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SPRulesCount',
    'SPRECOGNIZERSTATUS'
]
